                ...
                if (snapshot.exists()){
                    ...
                    for (String key : dataMap.keySet()){
                        ...
                        try{
                            ...
                            dataValues.add(new DriversOffenceModel(userData.get("driverName").toString(), userData.get("selectedSex").toString(), userData.get("licenseNumber").toString(),userData.get("driverOffenceDescription").toString()));
